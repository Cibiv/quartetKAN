...
path='../raw/zone/test/strepsiptera/quartet-alignments/'

# create data file
data_file_name = sys.argv[1] if len(sys.argv) > 1 else '../processed/zone/test/strepsiptera/quartet/strepsiptera_freqs_permuted.csv'
