...
from base_zwei import LayerKAN
from dense_kan_zwei import DenseKAN
import spline_zwei 
...
class KAN:
    ...
    def get_model(self, w_init, b_init):
      ...
      #########################
        ...
        #hidden layers ohne activation fkt und ohne dropout:
...
if __name__ == '__main__':
    try:
        # create KAN instance taking config path in first sys argument as input
        nn = KAN(sys.argv[1])
        # train network
        nn.train()
