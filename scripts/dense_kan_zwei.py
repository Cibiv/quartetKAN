"""
This python file is based on dense.py of the package tfkan and was only slightly adapted.
The adaptions enable _check_and_reshape_inputs to deal also with inputs with none-dimensions (which happens e.g. when using an iterator).
"""

import tensorflow as tf
from keras.layers import Layer
from tfkan.layers.base import LayerKAN
from tfkan.ops.spline import fit_spline_coef
